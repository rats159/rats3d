...
public class StaticShader extends Shader{
   ...
   private static final String VERTEX_PATH = "src/main/java/dev/rats159/rats3d/shaders/vertex.glsl";
   private static final String FRAGMENT_PATH = "src/main/java/dev/rats159/rats3d/shaders/fragment.glsl";
